...
use  "$Output\Panel_filtered_SMEs.dta", replace
...
esttab a* using "$Output/table1_SMEs.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: Survival SMEs}) ////
		wrap legend nogaps label ///
		addnotes("Source: The author")

esttab a* using "$Output/table1_SMEs.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: Survival SMEs}) ////
		wrap legend nogaps label ///
		addnotes("Source: The author")
...
//Tables
esttab b* using "$Output/table2_SMEs.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: Innovation Outcomes SMEs}) ////
		wrap legend nogaps label ///
		addnotes("Source: The author")


esttab b* using "$Output/table2_SMEs.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: Innovation Outcomes SMEs}) ////
		wrap legend nogaps label ///
		addnotes("Source: The author")
...
esttab cmpmdyn* using "$Output/table3_SMEs_ME.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: CDM-Dynamic: marginal effects SMEs}) ////
...
esttab cmpdyn* using "$Output/table3_SMEs_coeff.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table: CDM-Dynamic: Coefficients SMEs}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Own Collaboration, given data")
********************************************************************************
** END
